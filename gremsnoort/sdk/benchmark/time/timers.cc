...
#include <gremsnoort/sdk/benchmark/time/internal_macros.h>
...
std::string LocalDateTimeString() {
  ...
  if (tz_len < kTzOffsetLen && tz_len > 1) {
    ...
    //BM_CHECK(tz_len == kTzOffsetLen); // @NOTE
  ...
  //BM_CHECK(timestamp_len == kTimestampLen); // @NOTE
